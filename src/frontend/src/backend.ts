...
import type { Cart as _Cart, Category as _Category, OrderData as _OrderData, Product as _Product, ProductStatus as _ProductStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async checkCallerUserRole(): Promise<UserRole> {
        if (this.processError) {
            try {
                const result = await this.actor.checkCallerUserRole();
    ...
    async createProduct(arg0: Product): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createProduct(to_candid_Product_n5(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOrder(arg0: bigint): Promise<OrderData | null> {
        if (this.processError) {
            try {
    ...
    async getOrders(): Promise<Array<OrderData>> {
        if (this.processError) {
            try {
    ...
    async isAdmin(arg0: Principal | null): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isAdmin(to_candid_opt_n19(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Cart]): Cart | null {
...
function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_OrderData]): OrderData | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? ProductStatus.pending : "approved" in value ? ProductStatus.approved : "rejected" in value ? ProductStatus.rejected : "draft" in value ? ProductStatus.draft : value;
}
...
function to_candid_ProductStatus_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductStatus): _ProductStatus {
...
function to_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: to_candid_ProductStatus_n7(_uploadFile, _downloadFile, value.status),
        title: value.title,
        description: value.description,
        stock: value.stock,
        category: value.category,
...
function to_candid_variant_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductStatus): {
    pending: null;
} | {
    approved: null;
} | {
    ...
    return value == ProductStatus.pending ? {
        pending: null
